...
const BINNACLE_STORAGE_KEYS = {
  ...
  lowKeyAlarms: { key: 'binnacle-custom:low-key-alarms', scope: 'safety' },
  ...
  aisNameMode: { key: 'binnacle-custom:ais-name-mode', scope: 'profile' },
  ...
  instrumentHistoryWindows: {
    key: 'binnacle-custom:instrument-history-windows',
    scope: 'device',
  },
