...
export function createAisVectorsOverlay(
  ...
  return {
    ...
    description:
      "Solid line uses reported COG and SOG until repeated positions support differing observed motion. A dashed line retains the report. Both share the target icon's blue, amber, or red CPA grade.",
    band: BAND,
